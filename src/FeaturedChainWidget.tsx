...
> = {
  bitcoin: {
    wrapper: 'rounded-2xl border-2 border-amber-400 bg-amber-950/20 p-4 md:p-5 ring-1 ring-amber-400/50 [&_button]:border-amber-400/60',
    heading: 'font-display text-lg tracking-wider text-amber-200/90 mb-3',
  },
  ethereum: {
    wrapper: 'rounded-2xl border-2 border-blue-500/30 bg-blue-950/20 p-4 md:p-5',
    heading: 'font-display text-lg tracking-wider text-blue-200/90 mb-3',
  },
};
  ...
  return (
    <div className={wrapper}>
      ...
      {chain ? (
        ...
        <div className="rounded-2xl glass p-8 text-center text-white/50">
          Loading…
        </div>
      )}
    </div>
